...
public class BirthStones {
    public static void main(String[] args) {
        ...
        System.out.print("Which Month's birthstone do you want to know? ");
        stoneMonth = Integer.parseInt(inputReader.nextLine());
        ...
        switch (stoneMonth) {
            ...
            default:
                System.out.println("You must be confused, " + stoneMonth + " doesn't match a month.");
                break;
        }
    }
}
